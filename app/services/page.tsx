...
const services = [
  ...
  { icon: Palette, number: '03', title: 'UI/UX Design', description: 'Distinctive interfaces that feel effortless to use and unmistakably connected to your brand.', features: ['Experience Research', 'Interface Design', 'Usability Testing'], tone: 'accent' },
