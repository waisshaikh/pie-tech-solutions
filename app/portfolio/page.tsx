...
const projects = [
  { number: '01', title: 'Oblix Pharma', category: 'Healthcare · Web Development', description: 'A polished pharmaceutical website presenting the company, products and healthcare expertise through a clear digital experience.', tags: ['Healthcare', 'Responsive', 'Corporate'], cover: '/portfolio/oblixpharma.webp', href: 'https://oblixpharma.com/' },
  { number: '02', title: 'Saleem Bridals', category: 'Fashion · E-commerce', description: 'An elegant bridal shopping experience designed to showcase collections and help customers discover statement occasion wear.', tags: ['E-commerce', 'Fashion', 'Mobile'], cover: '/portfolio/saleem%20%20bridal.webp', href: 'https://saleemsbridalstore.com/' },
  { number: '03', title: 'Aaeesha Boutique', category: 'Fashion · Boutique', description: 'A contemporary boutique storefront balancing expressive fashion imagery with a simple, conversion-focused shopping journey.', tags: ['Boutique', 'Commerce', 'UI/UX'], cover: '/portfolio/aaeesha%20boutique.webp', href: 'https://aaeeshaboutique.com/' },
  { number: '04', title: 'SK Corporate Wear', category: 'Corporate Fashion · E-commerce', description: 'A professional corporate-wear storefront showcasing uniforms, workwear collections and tailored apparel solutions.', tags: ['Corporate Wear', 'E-commerce', 'Responsive'], cover: '/portfolio/sk%20corporate.webp', href: 'https://skcorporatewear.com/' },
  { number: '05', title: 'Gulmarg Destinations', category: 'Travel · Tourism', description: 'An immersive destination website helping travellers explore Gulmarg experiences, stays and memorable mountain adventures.', tags: ['Travel', 'Destination', 'Responsive'], cover: '/portfolio/gulmarg.webp', href: 'https://gulmarg-destinations.vercel.app/' },
] as const;
